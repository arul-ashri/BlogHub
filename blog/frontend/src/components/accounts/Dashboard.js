                ...
                <tbody>
                    {articles.map(article => (
                        <tr key={article.id}>
                            <td>{article.title}</td>
                            <td>
                                <img src={article.image} alt="" width="150px" height="80px"/>
                            </td>
                            ...
                            <td>
                                <button data-articleid={article.id} onClick={articleDelete} type="button" className="btn btn-danger">Delete</button>
                            </td>
                        </tr>
                    ))}
